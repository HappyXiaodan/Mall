 ...
 * 
 * Include: CSS3, HTML5, Misc, Extra ( Just 'Add CSS Class' ), Extensibility, Non-core Detects ( All, except 'css-mediaqueries' )
 * 
 * Build: http://modernizr.com/download/#
 ...
 -mathml-network_connection
 
 -network_eventsource
 
 -network_xhr2-notification
 ...
 -script_async-script_defer
 
 -style_scoped
 
 -svg_filters
 
 -unicode-url_data_uri
...
// By Theodoor van Donge
Modernizr.addTest('scriptdefer', 'defer' in document.createElement('script'));// test if IE userdata supported
