 ...
 * 
 * Describe: The javascript boot file of forget password ( index.html ).
 * 
 ...
 * Version: 0.1.0
 * 
 * Creation Date: 2013.10.29 20:40 ( Doris ).
 * 
 * Last update: 2013.10.29 20:40 ( Doris ).
 * 
 * License: ~
 * 
 * Copyright: ~
...
(function (window, document, requirejs, require) {
	...
	boot.req = function (jquery) {
		...
		require([
			...
			'cdnjs/jquery_forget_password/0.1.0/jquery.forget.password',
			
			'cdnjs/gridder/0.1.0/gridder',
			
			'cdnjs/jquery_title_modify/title.modify'
		
		], function (modernizr, SJ, cookie, Dretrievepwd, gridder, modifyTitle) {
