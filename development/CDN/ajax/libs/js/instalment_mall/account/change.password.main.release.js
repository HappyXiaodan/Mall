 ...
 * 
 * Describe: The javascript boot file of account page (change.password).
 * 
 ...
 * Version: 0.1.0
 * 
 * Creation Date: 2013.10.22 10:28 ( Doris ).
 * 
 * Last update: 2013.10.22 10:41 ( Doris ).
 * 
 * License: ~
 * 
 * Copyright: ~
	...
	boot.req = function (jquery) {
		...
		require([
			...
			SJ(function ($) {
				...
				$('.leftSidebar, .rightContainer').css({"height": docHeight-headerHeight});
