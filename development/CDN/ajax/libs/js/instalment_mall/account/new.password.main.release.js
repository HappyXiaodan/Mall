 ...
 * 
 * Describe: The javascript boot file of forget password ( new.password.html ).
 * 
 ...
 * Version: 0.1.0
 * 
 * Creation Date: 2013.10.30 10:32 ( Doris ).
 * 
 * Last update: 2013.10.30 10:32 ( Doris ).
 * 
 * License: ~
 * 
 * Copyright: ~
...
(function (window, document, requirejs, require) {
	...
	boot.req = function (jquery) {
		...
		require([
			...
			'cdnjs/jquery_confirm_password/0.1.0/jquery.confirm.password',
			
			'cdnjs/gridder/0.1.0/gridder',
			
			'cdnjs/jquery_title_modify/title.modify'
		
		], function (modernizr, SJ, cookie, Dnewpwd, gridder, modifyTitle) {
