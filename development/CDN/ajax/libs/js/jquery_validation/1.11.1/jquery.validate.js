		...
		prototype: {
			...
			init: function () {
				...
				var s_delegate = ":text, [type='password'], [type='file'], select, textarea, " +
					...
					click_delegate = "[type='radio'], [type='checkbox'], select, option";
				
				$(this.currentForm).validateDelegate(s_delegate, "keyup focusin focusout", delegate).validateDelegate(click_delegate, "click", delegate);
			...
			remote: function( value, element, param ) {
				...
				$.ajax($.extend(true, {
					...
					success: function( response ) {
						...
						if (response.result === 'true' || response.result === true || response === true || response === 'true') {

							responseHawaii = true;

						}

						var valid = responseHawaii; //origin: var valid = response === true || response === "true";
						...
						if ( valid ) {
							...
							var message = responseReal || validator.defaultMessage( element, "remote" );
